...
//     console.log(presidents[item].first, presidents[item].last);
// }
...
//         //console.log(i);//console logs array position
//         console.log(presidents[i].first, presidents[i].last);
//     }
// }
...
for (let i=0; i < MarcoStudents.length; i++) {
    //console.log(i);
    console.log(MarcoStudents[i].name + ` - ` + MarcoStudents[i].subject);
}
